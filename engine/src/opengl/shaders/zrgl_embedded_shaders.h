...
"    // vec4 data1 = DataIndexToPixel(root + 0, u_dataTexSize)\n"
"    // vec4 data1 = vec4(texelFetch(u_dataTexture, ivec2(root, 0), 0));\n"
"    // vec4 data2 = vec4(texelFetch(u_dataTexture, ivec2(root + 1, 0), 0));\n"
"    // vec4 data3 = vec4(texelFetch(u_dataTexture, ivec2(root + 2, 0), 0));\n"
"    // vec4 data4 = vec4(texelFetch(u_dataTexture, ivec2(root + 3, 0), 0));\n"
"\n"
"    mat4 u_modelView = u_projection;\n"
"\n"
