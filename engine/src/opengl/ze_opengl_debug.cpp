...
//////////////////////////////////////////////////
// This class should be isolated and purely for
// debugging/tests etc
//////////////////////////////////////////////////
...
//////////////////////////////////////////////////
internal i32 g_bInitialised = NO;

internal ZRShader g_shader = {};
internal u32 g_meshId = 0;

internal u32 g_quadVAO;
internal u32 g_quadVBO;

// 2 tris == 6 verts * 3 components each == 18
internal f32 g_quadVerts[18] = 
{
    -0.5, -0.5,  0,
	 0.5, -0.5,  0,
	 0.5,  0.5,  0,
...
internal f32 g_modelMatrix[16];
internal f32 g_viewMatrix[16];
internal f32 g_projMatrix[16];
...
ze_external void ZRGL_Debug_Init()
{
    ...
    ZRGL_CreateProgram(
        pass_vert_text, debug_frag_text, "test", 0, NO, &g_shader);
    // ZRGL_CreateProgram(
    //     fallback_vert_text, fallback_frag_text, "fallback", 0, NO, &g_shader);
    printf("Created GL Debug data\n");
}
